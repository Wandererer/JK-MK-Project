...
public class LowPolyLaser : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Physics.Raycast(transform.position, transform.forward, out hit))
        {
            ...
            transform.localScale = Vector3.Lerp(transform.localScale, new Vector3(1, 1, (distanceToHitPoint * zScaleFactor)),
                (beamExtendSpeed * Time.deltaTime)); // Because distance-units != scale-units.
        ...
        else
        {
            ...
            transform.localScale = Vector3.Lerp(transform.localScale, new Vector3(0, 0, transform.localScale.z),
